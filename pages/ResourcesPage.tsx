...
import { YOUTUBE_VIDEOS, DOCUMENT_RESOURCES } from '../constants';
            ...
            <div className="container mx-auto px-6 py-20">
                ...
                <section id="documents" className="mt-20">
                    ...
                    <div className="max-w-4xl mx-auto space-y-6">
                        {DOCUMENT_RESOURCES.map((doc, index) => (
                            <div key={index} className="bg-white p-6 rounded-lg shadow-xl flex items-center justify-between flex-wrap gap-4">
