                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start">
                                ...
                                <div>
                                    ...
                                    <a href="tel:515-555-0123" className="text-gray-300 hover:text-brand-gold">(515) 555-0123</a>
                                </div>
                            </div>
                            <div className="flex items-start">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:support@newhollandfinancial.com" className="text-gray-300 hover:text-brand-gold transition-colors duration-300">support@newhollandfinancial.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
