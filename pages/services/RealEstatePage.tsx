...
const RealEstatePage: React.FC = () => {
    ...
    return (
        <ServicePageLayout
            ...
            seoDescription="Explore real estate services for residential, commercial, and investment properties with New Holland Financial Group. Expert guidance on buying and selling."
            seoKeywords="real estate, buying a home, selling a home, commercial property, investment property"
            icon={
