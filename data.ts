...
// FIX: Using JSX in a .ts file is causing parsing errors. Converted the AIGLogo component and its usage to use React.createElement to avoid JSX syntax and resolve compilation errors.
  ...
  "life": [
    {
      ...
      "benefits": ["Lifetime protection", "Tax-deferred growth", "Borrowing options"]
    },
    {
      "name": "Universal Life Insurance",
      "description": "Flexible premiums and adjustable death benefits.",
      "benefits": ["Cash value growth", "Flexibility", "Tax advantages"]
    },
    {
      "name": "Indexed Universal Life (IUL)",
      "description": "Tied to market performance (e.g., S&P 500) with downside protection.",
      "benefits": ["Growth potential", "Living benefits", "Tax-free loans"]
    },
    {
      "name": "Annuities",
      "description": "Guaranteed income for retirement.",
      "benefits": ["Lifetime income", "Principal protection", "Growth options"]
    },
    {
      "name": "Term Life",
      "description": "Affordable coverage for a set period (10, 20, 30 years).",
      "benefits": ["High coverage", "Low cost", "Simple protection"]
    },
    {
      "name": "Term Life with Living Benefits",
      "description": "Adds protection for illness or injury.",
      "benefits": ["Access cash while living for critical, chronic, or terminal conditions."]
    }
  ],
  "auto": [
    {
      ...
      "benefits": ["Covers liability, collision, and comprehensive damages."]
    },
    {
    ...
    },
    {
      ...
      "benefits": ["Protects against liability, damage, and downtime."]
    }
  ],
  "property": [
    {
  ...
  "health": [
    {
      ...
      "benefits": ["Access to quality care", "Preventive benefits", "Affordable premiums"]
    }
  ],
  "group-benefits": [
    {
